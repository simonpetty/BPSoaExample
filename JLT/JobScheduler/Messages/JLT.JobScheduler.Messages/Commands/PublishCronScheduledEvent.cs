...
{
    public class PublishCronScheduledEvent<T> : IPublishCronScheduledEvent<T> where T : class
    {
        public PublishCronScheduledEvent(CronScheduleBuilder scheduleBuilder, Uri destination, T payload)
        {
